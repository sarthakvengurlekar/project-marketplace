...
function CardTile({
  ...
  return (
    <div className="bg-zinc-900 border border-zinc-800 rounded-2xl overflow-hidden ring-1 ring-yellow-400/5 hover:ring-yellow-400/20 transition-all group relative">
